namespace WFM.JW.HB.Web.Report
{
    using System;
    ...
    public class SAccountReport
    {
       // private XNamespace XNS;
        public Workbook SAReport { get; set; }

        public SAccountReport(string templatename)
        {
        ...
        public void GenerateReport(string sheetname, IEnumerable list)
        {
            ...
            foreach (Models.SettlementRecord sa in list)
            {
                ...
                //部门
                row.Cells.Add(sa.Contract.Department.DepartmentName, DataType.String, style);
                //合同类别
                row.Cells.Add(sa.Contract.ContractType.ItemName, DataType.String, style);
                //项目名称
                row.Cells.Add(sa.Contract.Project.ProjectName, DataType.String, style);
                //合同编号
                row.Cells.Add(sa.Contract.ContractCode, DataType.String, style);
                //合同名称
                ...
                //备注
                row.Cells.Add(sa.Contract.Comment, DataType.String, style);
                //归档
                row.Cells.Add(sa.Contract.Filing, DataType.String, style);
