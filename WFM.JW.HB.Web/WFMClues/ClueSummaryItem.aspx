<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ClueSummaryItem.aspx.cs" Inherits="WFM.JW.HB.Web.WFMClues.ClueSummaryItem" %>
           ...
           >
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="序号" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <%# this.CLGridClueSummary.PageIndex * this.CLGridClueSummary.PageSize + CLGridClueSummary.Rows.Count + 1%>
                    </ItemTemplate>
