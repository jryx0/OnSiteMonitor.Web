...
{
    public partial class ClueSummaryItem : CLBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var mes = GetUrlPara<Models.Messaging<Models.WFMClueSummary>>("id");
        ...
        void GoPage(int CurrentPage)
        {
            ...
            //var summaryList = crs.GetPageDataByItem(SelectedRegion.Level + SelectedRegion.DirectCity, spec, ps.CurrentPageNo, ps.EachPageTotal);
