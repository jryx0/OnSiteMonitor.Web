<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ClueReportItem.aspx.cs" Inherits="WFM.JW.HB.Web.WFMClues.ClueReportItem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="ScrollList" style="width: 990px; overflow: auto;">
        <cc1:CLGridViewEx ID="CLGridClueReport" runat="server" AutoGenerateColumns="False"
            ...
            DataKeyNames="DataItem">
            <AlternatingRowStyle BackColor="#EEEEEE" />
            <SelectedRowStyle CssClass="tr-selected" />
            <Columns>
                <asp:BoundField DataField="DataItem" HeaderText="DataItem" Visible="False" />
                ...
                <asp:TemplateField HeaderText="项目名称">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" CssClass='mlength-4' Text='<%# Bind("DataName") %>'
                            ToolTip='<%# Eval("DataName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="备注">
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" CssClass="mlength-2" Text=''></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Right" />
                </asp:TemplateField>
