<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DepartmentEdit.aspx.cs" Inherits="WFM.JW.HB.Web.CMSDepartment.DepartmentEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:HiddenField ID="DepartmentID" Value="0" runat="server" />
    <asp:HiddenField ID="Version" Value="0" runat="server" />
   
    <div class="span-23 Query groupingborder">
        <div class="span-23 prepend-1 Magin-1">
            <asp:Label ID="Label4" runat="server" Text="部门名称:" CssClass="span-3"></asp:Label>
            <asp:TextBox ID="DepartmentNameTextBox" runat="server" CssClass="title span-5"></asp:TextBox>
        </div>
        <div class="span-23 prepend-1 Magin-1">
            <asp:Label ID="LabelEnable" runat="server" Text="状态:" CssClass="span-3" Visible="false"></asp:Label>
            <asp:DropDownList ID="DepartmentEnable" runat="server" Visible="false">
